...
int main()
{
    ...
    cout << "Sucess. New balance is: " << Acc3.GetBalance() << endl;
    Acc2.Transfer(500, Acc6);



    /*
    if(Acc2-=(200))
        cout << "Sucess. New balance is: " << Acc2.GetBalance() << endl;
    else
        cout << "Opperation failed" << endl;

    if(Acc2-=(900))
        cout << "Sucess. New balance is: " << Acc6.GetBalance() << endl;
    else
        cout << "Opperation failed" << endl;
